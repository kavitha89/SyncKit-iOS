...
@interface TurbineListViewController ()<kSyncConflictManagerDelegate>
{
    kSyncKit *syncKit;
...
@implementation TurbineListViewController
...
- (void)itemsSynced
{
    pipeItems = [NSMutableArray arrayWithArray:[[kSyncEngine sharedEngine] fetchAllRecordsForManagedObjectClass:@"Turbine"]];
...
- (void)addAuthorPressed {
    [self performSegueWithIdentifier:@"turbineDetails" sender:nil];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView_ cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	cell.textLabel.text =  tbItem.trbName;
    cell.detailTextLabel.text = tbItem.trbLocation;
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    {
        Turbine *pipeItem = [pipeItems objectAtIndex:indexPath.row];
